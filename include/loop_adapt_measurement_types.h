...
typedef void (*measurement_startall_function)();
typedef void (*measurement_stop_function)(int instance);
typedef void (*measurement_stopall_function)();
...
typedef struct {
    ...
    measurement_startall_function startall;
    measurement_stop_function stop;
    measurement_stopall_function stopall;
