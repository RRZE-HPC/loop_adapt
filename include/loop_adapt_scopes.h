...
#define LOOP_ADAPT_SCOPE_GPU_OFFSET 6

#define LOOP_ADAPT_NUM_SCOPES 7
...
typedef enum {
    ...
    LOOP_ADAPT_SCOPE_GPU = HWLOC_OBJ_OS_DEVICE,
...
static const int LoopAdaptScopeList[LOOP_ADAPT_NUM_SCOPES] = {
    ...
    [LOOP_ADAPT_SCOPE_GPU_OFFSET] = LOOP_ADAPT_SCOPE_GPU
};
