...
/*static int _loop_adapt_registered_threads = 1;*/
...
/*    dlclose(handle);*/
/*    int tid = _loop_adapt_registered_threads++;*/
/*    DEBUG_PRINT(LOOP_ADAPT_DEBUGLEVEL_DEBUG, Registering thread %d, tid);*/
/*    loop_adapt_threads_register(tid);*/
/*    return ret;*/
/*}*/

/*void pthread_exit(void *retval)*/
/*{*/
/*    printf("Own pthread_exit\n");*/
/*    void *handle;*/
/*    char *error;*/
/*    int (*rptc) (void *);*/
/*    int ret;*/
...
/*    }*/
/*    dlerror();*/
/*    rptc = dlsym(handle, "pthread_exit");*/
/*    if ((error = dlerror()) != NULL)*/
/*    {*/
/*        printf("%s\n", error);*/
/*    }*/
